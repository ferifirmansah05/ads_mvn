            ...
            for cab in all_cab:
                ...
                for date in all_date:
                    ...
                    if 'GOJEK' in all_kat:
                        ...
                        st.write(cn[(cn['TANGGAL']==int(re.findall(r'\d+', date)[-1])) & (cn['CAB']==cab) & (cn['TYPE BAYAR']=='GO RESTO')])
                        for i in cn[(cn['TANGGAL']==int(re.findall(r'\d+', date)[-1])) & (cn['CAB']==cab) & (cn['TYPE BAYAR']=='GO RESTO')].index:
                                                ...
                                                if abs(all_2.loc[i,'TIME'] - all_1.loc[x,'TIME']) < abs(all_1.loc[y,'TIME'] - all_1.loc[x,'TIME']):
                                                    ...
                                                    if all_2.loc[i,'NOM'] == all_1.loc[x,'NOM']:
                                                        ...
                                                        if all_2.loc[i,'SOURCE'] =='WEB':
                                                            ...
                                                            all_2.loc[i,'KET'] =  'Selisih '+ str(all_2.loc[i,'ID']) + difference(all_2.loc[i,'NOM'],all_1.loc[x,'NOM'])
                                                            all_1.loc[x,'KET'] =  'Selisih '+ str(all_2.loc[i,'ID']) + difference(all_2.loc[i,'NOM'],all_1.loc[x,'NOM'])
