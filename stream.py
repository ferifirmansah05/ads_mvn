        ...
        with tempfile.TemporaryDirectory() as tmpdirname:
            ...
            for file in files:
                    try:
                            ...
                            df['NAMA TAMU'] = df['NAMA TAMU'].str.upper()
                            df = df[~((df['TYPE BAYAR']=='GRAB FOOD') & ~(df['NAMA TAMU'].str.contains('GF')))]
                            dfs.append(df)
            ...
            if 'dfweb' in locals(): 
                ...
                dfweb['KAT'] = dfweb['KAT'].replace({'SHOPEE PAY': 'SHOPEEPAY', 'SHOPEEFOOD INT': 'SHOPEEPAY', 'GORESTO': 'GO RESTO','GOFOOD':'GO RESTO' ,'GRAB': 'GRAB FOOD', 'QRIS ESB ORDER':'QRIS ESB','QRIS BNI':'EDC'})
